...
/*******************************************************************/
#ifndef DECL_POLYHLC
#ifndef DCL_POLYHLC_H
#define DCL_POLYHLC_H
#if defined( __poly_hlc_husk )
#define BUILDING_LOCAL_FILE
#endif
#include "importexport.h"

#ifdef BUILDING_LOCAL_FILE
#define DECL_POLYHLC EXPORT_SYMBOL
#else
#define DECL_POLYHLC IMPORT_SYMBOL
#endif
#else
# define DECL_POLYHLC IMPORT_SYMBOL
#endif
...
#  if defined(_MSC_VER)
#    define spa_lib_name "poly_hlc_husk"
