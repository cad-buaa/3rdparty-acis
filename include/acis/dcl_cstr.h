...
#if defined( __constrct ) || defined( __SpaACIS ) || defined( __SPAAcisDs )
#define BUILDING_LOCAL_FILE
#endif

#include "importexport.h"
#include "acis/gme/constructor/gme_constructor.hxx"

#ifdef IMPORT_EXPORT_SYMBOLS
# ifdef BUILDING_LOCAL_FILE
#  define DECL_CSTR EXPORT_SYMBOL
# else
#  define DECL_CSTR IMPORT_SYMBOL
# endif
#else
# define DECL_CSTR
#endif
