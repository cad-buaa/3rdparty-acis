...
#ifndef DECL_DMGI_CONTROL

#if defined( __admgi_control ) || defined( __admgi_control )
...
#  define DECL_DMGI_CONTROL EXPORT_SYMBOL
# else
#  define DECL_DMGI_CONTROL IMPORT_SYMBOL
# endif
#else
# define DECL_DMGI_CONTROL
#endif
...
#    define spa_lib_name "admgi_control"
#   else
#    define spa_lib_name "admgi_control"
#   endif
