...
class DECL_KERN intcurve : public curve {
    // NOTES SHEVO
    friend int_cur* shevo_get_int_cur(intcurve* ic);
...
#    endif
  ...
  public:
     ...
     */
    intcurve(bs3_curve cur, double tol, surface const& surf1, surface const& surf2, bs2_curve cur1 = NULL, bs2_curve cur2 = NULL, const SPAinterval& inter = *(const class SPAinterval*)NULL_REF, logical parametric_is_primary = FALSE,
     ...
     * optional transformation.
     */
    SPAbox bound(double start, double end, SPAtransf const& t = *(SPAtransf*)NULL_REF) const { return bound(SPAinterval(start, end), t); }
     ...
     * region of interest.
     */
    virtual BOUNDING_CYLINDER enclosing_cylinder(const SPAinterval& inter = *(SPAinterval*)NULL_REF) const;
    /**
     ...
     * @nodoc
     */
    int_cur const& get_int_cur() const { return *fit; }
     ...
     */
    friend DECL_KERN intcurve operator*(intcurve const&, SPAtransf const&);
    /**
...
class DECL_KERN int_cur : public subtrans_object {
    // NOTES SHEVO
    friend bs2_curve shevo_get_pcur1(int_cur* ptr);
...
#    endif
    ...
    disc_info_status validate_disc_info(const discontinuity_info& supplied, const discontinuity_info& calculated, unmarked_discon_type& discon_type, int to_order = 3) const;
  ...
  protected:
     ...
     */
    int summary_nknots() const { return summary_data->nknots; }
    /**
     * Returns the knots in summary data.
     */
    const double* summary_knots() const { return summary_data->_knots; }
    /**
     * Returns the degree of summary_data.
     */
    int summary_degree() const { return summary_data->deg; }
    /**
    ...
    void delete_tight_summary_data() {
        ACIS_DELETE tight_summary_data;
        tight_summary_data = NULL;
    }
     ...
     * Discontinuities.
     */
    int_cur(bs3_curve bs3, double bs3tol, surface const& surf1, surface const& surf2, bs2_curve pcurve1, bs2_curve pcurve2, const SPAinterval& safe_range = *(const class SPAinterval*)NULL_REF,
     ...
     * Discontinuities.
     */
    int_cur(const SPAinterval& curv_int, closed_forms cform, surface const& surf1, surface const& surf2, bs2_curve pcurve1, bs2_curve pcurve2, const SPAinterval& safe_range = *(const class SPAinterval*)NULL_REF,
            const discontinuity_info& disc_info = *(discontinuity_info*)NULL_REF);
    /**
     ...
     */
    virtual void closest_point(SPAposition const& pos, SPAposition& foot, SPAparameter const& param_guess = *(SPAparameter*)NULL_REF, SPAparameter& param_actual = *(SPAparameter*)NULL_REF) const {
        point_perp(pos, foot, *(SPAunit_vector*)NULL_REF, *(SPAvector*)NULL_REF, param_guess, param_actual, FALSE);
    }
    /**
     ...
     */
    double param_with_cache(SPAposition const& pos, SPAparameter const& param = *(SPAparameter*)NULL_REF);
    /**
     ...
     */
    virtual int accurate_derivs(SPAinterval const& roi = *(SPAinterval*)NULL_REF
     ...
     * Given parameter value.
     */
    SPAparameter limit_param(SPAparameter const& param) const;
    /**
     ...
     * for most derived classes.
     */
    virtual logical test_point_tol(SPAposition const& point, double tol = 0, SPAparameter const& param_guess = *(SPAparameter*)NULL_REF, SPAparameter& param_actual = *(SPAparameter*)NULL_REF) const;
     ...
     * region of interest.
     */
    virtual BOUNDING_CYLINDER enclosing_cylinder(const SPAinterval& interv = *(SPAinterval*)NULL_REF) const;
    /**
...
#    endif
  ...
  public:
     ...
     */
    logical closed() const { return closure == CLOSED || closure == PERIODIC; }
    /**
     * @nodoc
...
#    endif
    ...
    virtual int evaluate_surfs(double param, SPAposition& pt, SPAvector* der, int& nd_cu, int& nd_sf, evaluate_curve_side location = evaluate_curve_unknown, SPAposition& pt1 = *(SPAposition*)NULL_REF, SPAvector* der1 = NULL,
                               SPAposition& pt2 = *(SPAposition*)NULL_REF, SPAvector* der2 = NULL, SPApar_pos& param1 = *(SPApar_pos*)NULL_REF, SPApar_vec* derparam1 = NULL, SPApar_pos& param2 = *(SPApar_pos*)NULL_REF, SPApar_vec* derparam2 = NULL,
                               SPApar_pos const& guess1 = *(SPApar_pos*)NULL_REF, SPApar_pos const& guess2 = *(SPApar_pos*)NULL_REF) const;
    /**
     * @nodoc
     * Internal use. Roll mechanism.
     */
     ...
     */
    double param_period() const { return closure == PERIODIC ? range.length() : 0.0; }
    /**
     ...
     */
    logical periodic() const { return closure == PERIODIC; }
    /**
     * Returns <tt>TRUE</tt> if the n<sup>th</sup> parameter-space curve is defined.
     * <br><br>
     * <b>Role:</b> Returns <tt>TRUE</tt> if the n<sup>th</sup> parameter-space curve is defined
  ...
  public:
    // SHIVELINO: acisadaptor module add.
    bs3_curve get_cur_data();
    double get_fitol_data();
    surface* get_surf1_data();
    surface* get_surf2_data();
    bs2_curve get_pcur1_data();
    bs2_curve get_pcur2_data();
    SPAinterval get_safe_range();
    void set_fitol_data(double data);
    void set_safe_range(SPAinterval data);
};
