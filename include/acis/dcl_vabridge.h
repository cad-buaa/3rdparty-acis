...
#ifndef DECL_VABRIDGE

#if defined( __vabridge ) || defined( __SpaVABridge )
...
#  define DECL_VABRIDGE EXPORT_SYMBOL
# else
#  define DECL_VABRIDGE IMPORT_SYMBOL
# endif
#else
# define DECL_VABRIDGE
#endif
