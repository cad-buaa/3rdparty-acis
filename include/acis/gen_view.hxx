...
public:
    ...
    virtual void set_viewport(
        int x,          // Position of the viewport in the display window
        int y,
        int width,      // Size of the viewport (in pixels)
        int height) = 0;

    virtual void get_viewport(
        int &x,         // Position of the viewport in the display window
        int &y,
        int &width,     // Size of the viewport (in pixels)
        int &height ) = 0;
	...
	virtual void rotate(
		SPAunit_vector axis,   // Axis direction in model space
