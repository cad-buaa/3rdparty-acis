...
// 用于控制是否定义GME的MALLOC、CALLOC等函数，开启为定义
// #define GME_ALLOC
...
DECL_BASE void   gme_free( void * alloc_ptr);
    ...
    */
    ...
    extern DECL_BASE void * (*acis_allocate)( size_t alloc_size, AcisMemType alloc_type, enum AcisMemCall alloc_call,
        ...
        #else
     DECL_BASE void * (*acis_allocate)( size_t alloc_size, AcisMemType alloc_type, enum AcisMemCall alloc_call,
						    const char *alloc_file, int alloc_line, int *alloc_file_index);
#endif	
    /**
     * @nodoc
     */
    extern DECL_BASE void * (*gme_allocate)( size_t alloc_size, AcisMemType alloc_type, enum AcisMemCall alloc_call,
                                const char* alloc_file, int alloc_line, int* alloc_file_index);
    /**
     * @nodoc
     */
    ...
    #else
    DECL_BASE void   (*acis_discard)( void * alloc_ptr, enum AcisMemCall alloc_call, size_t alloc_size);
    #endif
    /**
     * @nodoc
     */
    extern DECL_BASE void   (*gme_discard)( void * alloc_ptr, enum AcisMemCall alloc_call, size_t alloc_size);
     ...
     * @nodoc
     */
    extern DECL_BASE void* (*gme_raw_malloc)(size_t);
    /**
     * @nodoc
     */
     ...
     * @nodoc
     */
    extern DECL_BASE void (*gme_raw_free)(void*);

    /**
     * @nodoc
     */
    extern logical acis_debug;
    extern DECL_BASE logical gme_debug;

    /**
     * @nodoc
     */
    extern logical acis_freelist;
    extern DECL_BASE logical gme_freelist;
