...
#ifndef DECL_VHABRIDGE

#if defined( __vhabridge ) || defined( __SPAVHABridge )
...
#  define DECL_VHABRIDGE EXPORT_SYMBOL
# else
#  define DECL_VHABRIDGE IMPORT_SYMBOL
# endif
#else
# define DECL_VHABRIDGE
#endif
