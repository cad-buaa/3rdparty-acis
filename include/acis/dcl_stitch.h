...
# if defined( __stchhusk ) || defined( __SpaACIS ) || defined( __SPAAcisDs )
...
#  define DECL_STITCH EXPORT_SYMBOL
# else
#  define DECL_STITCH IMPORT_SYMBOL
# endif
#else
# define DECL_STITCH
#endif
