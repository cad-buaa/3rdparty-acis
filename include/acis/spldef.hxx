...
#    endif
  ...
  public:
    ...
    */
     ...
     * transformation.
     */
    virtual SPAbox bound(SPApar_box const& box = *(SPApar_box*)NULL_REF, SPAtransf const& trans = *(SPAtransf*)NULL_REF) const;
     ...
     * parameter range.
     */
    SPAbox bound(SPAtransf const& trans, SPApar_box const& parbox = *(SPApar_box*)NULL_REF) const;
     ...
     * transformation.
     */
    virtual surf_normcone normal_cone(SPApar_box const& parbox,  // parameter bounds
                                      logical approx = FALSE, SPAtransf const& trans = *(SPAtransf*)NULL_REF) const;
     ...
     * parameter guess.
     */
    virtual SPAunit_vector point_normal(SPAposition const& pos, SPApar_pos const& guess = *(SPApar_pos*)NULL_REF) const;
     ...
     * parameter guess.
     */
    virtual SPAunit_vector point_outdir(SPAposition const& pos, SPApar_pos const& guess = *(SPApar_pos*)NULL_REF) const;
     ...
     * initial param guess.
     */
    virtual double point_cross(SPAposition const& pos, SPAunit_vector const& direction, SPApar_pos const& guess = *(SPApar_pos*)NULL_REF) const;
    ...
    virtual double point_cross(SPAposition const& pos, SPAunit_vector const& direction, SPApar_pos const& guess, logical use_sided_eval, logical right_side) const;
     ...
     * weak flag.
     */
    void point_perp(SPAposition const& pos, SPAposition& foot, SPApar_pos const& param_guess = *(SPApar_pos*)NULL_REF, SPApar_pos& param_actual = *(SPApar_pos*)NULL_REF, logical f_weak = FALSE) const {
        point_perp(pos, foot, *(SPAunit_vector*)NULL_REF, *(surf_princurv*)NULL_REF, param_guess, param_actual, f_weak);
    }
     ...
     * initial guess.
     */
    virtual SPApar_pos param(SPAposition const& pos, SPApar_pos const& guess = *(SPApar_pos*)NULL_REF) const;
     ...
     * parameter.
     */
    virtual SPApar_vec param_unitvec(SPAunit_vector const& direction, SPApar_pos const& parameter) const;
    /**
     * Finds the change in surface parameter corresponding to a unit offset in a given direction at a given position.
     * <br><br>
     * @param direction
     ...
     * given parameter-space location.
     */
    virtual SPAunit_vector eval_normal(SPApar_pos const& parameter) const;
     ...
     * given parameter-space location.
     */
    virtual SPAunit_vector eval_outdir(SPApar_pos const& parameter) const;
     ...
     */
    virtual void eval_prin_curv(SPApar_pos const& parameter,
                                SPAunit_vector& axis1,  // first axis direction
                                double& cur1,           // curvature in first direction
                                SPAunit_vector& axis2,  // second axis direction
                                double& cur2            // curvature in second direction
     ...
     * curve normal.
     */
    virtual double eval_cross(SPApar_pos const& parameter, SPAunit_vector const& normal) const;
     ...
     */
    virtual int evaluate(SPApar_pos const& parameter,  // Parameter
     ...
     */
    virtual int accurate_derivs(SPApar_box const& def = *(SPApar_box*)NULL_REF
     ...
     * region of interest.
     */
    virtual SPApar_box param_range(SPAbox const& region = *(SPAbox*)NULL_REF) const;
    /**
     * Returns the principal parameter range of a parametric surface in a chosen parameter direction.
     * <br><br>
     * <b>Role:</b> A periodic surface is defined for all parameter values in the
     ...
     * region of interest.
     */
    virtual SPAinterval param_range_u(SPAbox const& region = *(SPAbox*)NULL_REF) const;
    /**
     * Returns the principal parameter range of a parametric surface in a chosen parameter direction.
     * <br><br>
     * <b>Role:</b> A periodic surface is defined for all parameter values in the
     ...
     * region of interest.
     */
    virtual SPAinterval param_range_v(SPAbox const& region = *(SPAbox*)NULL_REF) const;
    ...
    virtual logical test_point_tol(SPAposition const& pos,
                                   ...
                                   SPApar_pos const& guess = *(SPApar_pos*)NULL_REF, SPApar_pos& actual = *(SPApar_pos*)NULL_REF) const;
    ...
    */
     ...
     */
    virtual check_status_list* check(const check_fix& input = *(const check_fix*)NULL_REF,
...
#    endif
  ...
  protected:
    ...
    virtual surf_normcone normal_cone(SPApar_box const& = *(SPApar_box*)NULL_REF, logical = FALSE);
  ...
  protected:
    ...
    virtual SPAunit_vector point_outdir(SPAposition const&, SPApar_pos const& = *(SPApar_pos*)NULL_REF) const;
    ...
    virtual void point_prin_curv(SPAposition const&,
                                 ...
                                 SPApar_pos const& = *(SPApar_pos*)NULL_REF, evaluate_surface_quadrant = evaluate_surface_unknown) const;
    ...
    virtual double point_cross(SPAposition const&, SPAunit_vector const&, SPApar_pos const& = *(SPApar_pos*)NULL_REF) const;
    ...
    void point_perp_with_cache(SPAposition const&, SPAposition&, SPAunit_vector&, surf_princurv&, SPApar_pos const& = *(SPApar_pos*)NULL_REF, SPApar_pos& = *(SPApar_pos*)NULL_REF, logical f_weak = FALSE, SPApar_box const& = *(SPApar_box*)NULL_REF) const;
    ...
    virtual void point_perp(SPAposition const&, SPAposition&, SPAunit_vector&, surf_princurv&, SPApar_pos const& = *(SPApar_pos*)NULL_REF, SPApar_pos& = *(SPApar_pos*)NULL_REF, logical f_weak = FALSE, SPApar_box const& = *(SPApar_box*)NULL_REF) const;
  ...
  protected:
    ...
    SPApar_pos param_with_cache(SPAposition const&, SPApar_pos const& = *(SPApar_pos*)NULL_REF);

    // Find the parameter values of a point on the surface.

    virtual SPApar_pos param(SPAposition const&, SPApar_pos const& = *(SPApar_pos*)NULL_REF) const = 0;
    ...
    virtual int accurate_derivs(SPApar_box const& = *(SPApar_box*)NULL_REF
                                // Defaults to the whole surface
    ) const;
