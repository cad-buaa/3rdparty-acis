...
#if defined( __boolean ) || defined( __SpaACIS ) || defined( __SPAAcisDs )
#define BUILDING_LOCAL_FILE
#endif

#include "importexport.h"
#include "acis/gme/boolean/gme_boolean.hxx"

#ifdef IMPORT_EXPORT_SYMBOLS
# ifdef BUILDING_LOCAL_FILE
#  define DECL_BOOL EXPORT_SYMBOL
# else
#  define DECL_BOOL IMPORT_SYMBOL
# endif
#else
# define DECL_BOOL
#endif
