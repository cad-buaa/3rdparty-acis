...
#if defined( __faceter ) || defined( __SpaACIS ) || defined( __SPAAcisDs )
#define BUILDING_LOCAL_FILE
#endif

#include "importexport.h"
#include "acis/gme/faceter/gme_faceter.hxx"

#ifdef IMPORT_EXPORT_SYMBOLS
# ifdef BUILDING_LOCAL_FILE
#  define DECL_FCT EXPORT_SYMBOL
# else
#  define DECL_FCT IMPORT_SYMBOL
# endif
#else
# define DECL_FCT
#endif
