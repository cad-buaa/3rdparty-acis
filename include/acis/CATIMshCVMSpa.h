...
class ExportedByCATMshCVMSpa CATIMshCVMSpa : protected CATIMshCVMCore<KERNEL> {
public:
    class impl;
    ...
    HRESULT AddBoundaryLayerGeometricConstraint(const CATMshTag tag,
                                                const double h0, const double p,
...
public:
    ...
    void SetComplexConformityEnforcement(
        const bool complexConformityEnforcement);
