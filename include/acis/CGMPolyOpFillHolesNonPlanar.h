...
public:
   ...
   **/
  static FillHolesNonPlanar *Create(HoleBoundary const &iBoundary1,
                                    HoleBoundary const &iBoundary2,
                                    CATListOfInt const &iConnectionPoints1,
                                    CATListOfInt const &iConnectionPoints2,
                                    CATListOfShort const &iConnectionIsStrong);
  ...
  {
    NoRefinement = 1,
    MaxCircumradiusRefinement = 2,
    MinAngleRefinement = 3
  };
