 ...
 * @return Indicates success or failure.
 */
DECL_VABRIDGE outcome 
api_va_generate_tessellation_mesh( ENTITY * body,
...
api_va_generate_tessellation_mesh( ENTITY* body,
								   va_surfmesh*& surface_mesh,
								   logical use_facet_options, 
								   facet_options* fo = NULL,
								   const va_surface_mesh_options* mesh_options = NULL, 
								   AcisOptions* ao = NULL );
 ...
 */
DECL_VABRIDGE
outcome api_va_generate_surface_mesh(const ENTITY_LIST &body_list,
                                     va_surfmesh * &surface_mesh,
                                     const va_surface_mesh_options *mesh_opts = NULL,
                                     AcisOptions *ao = NULL);
 ...
 */
DECL_VABRIDGE
outcome api_va_generate_surface_mesh(ENTITY* body,
                                     va_surfmesh*& surface_mesh,
                                     const va_surface_mesh_options* mesh_opts = NULL,
									 facet_options* facet_opts = NULL,
                                     AcisOptions* ao = NULL);
 ...
 */
DECL_VABRIDGE
outcome api_va_generate_tet_mesh(	ENTITY* body,
									va_tetmesh*& output_tetmesh,
									const va_surface_mesh_options* surf_mesh_opts = NULL,
 ...
 */
DECL_VABRIDGE outcome
api_va_generate_subset_surface_mesh( va_surfmesh* surface_mesh,
									 const ENTITY_LIST& cell_list,
									 va_surfmesh*& subset_mesh,
									 AcisOptions* ao = NULL);
 ...
 */
DECL_VABRIDGE
outcome api_va_generate_hybrid_mesh(BODY* body,
									const ENTITY_LIST& cell_list,
									va_volmesh*& output_volmesh,
									const va_surface_mesh_options* surf_mesh_opts = NULL,
									const va_tet_mesh_options* tet_mesh_opts = NULL,
									facet_options* facet_opts = NULL,
									AcisOptions* ao = NULL);
 ...
 */
DECL_VABRIDGE outcome
api_va_generate_hybrid_mesh( va_surfmesh* 		        input_surfmesh,
							 const ENTITY_LIST&         cell_list,
							 va_volmesh*&               output_volmesh,
                             const va_tet_mesh_options* tet_mesh_opts = NULL,
                             AcisOptions* 			    ao = NULL
 ...
 */
DECL_VABRIDGE outcome 
api_va_generate_surface_mesh(	const char *file_name,
								logical text_mode,
								va_surfmesh*& output_surfmesh,
								AcisOptions* ao = NULL);
 ...
 */
DECL_VABRIDGE outcome 
api_va_generate_tet_mesh(	const char *file_name,
							logical text_mode,
							va_tetmesh*& output_tetmesh,
							AcisOptions* ao = NULL);
 ...
 */
DECL_VABRIDGE outcome 
api_va_generate_hybrid_mesh(	const char *file_name,
								logical text_mode,
								va_volmesh*& output_volmesh,
								AcisOptions* ao = NULL);
 ...
 */
DECL_VABRIDGE
outcome api_va_generate_tet_mesh(const ENTITY_LIST &body_list,
                                 va_tetmesh * &out_mesh,
                                 const va_surface_mesh_options *surf_mesh_opts = NULL,
                                 const va_tet_mesh_options *tet_mesh_opts = NULL,
                                 AcisOptions *ao = NULL);
 ...
 */
DECL_VABRIDGE
outcome api_va_set_refinement( va_mesh *in_mesh,
                              int elem_idx,
                              double size,
                              AcisOptions *ao = NULL );
 ...
 */
DECL_VABRIDGE
outcome api_va_refine( va_mesh *in_mesh,
                       AcisOptions *ao = NULL );
 ...
 */
DECL_VABRIDGE outcome 
api_va_set_entity_size_control( ENTITY* ent,
								double size,
								va_base_mesh_options* mesh_opts,
								AcisOptions *ao = NULL);
...
DECL_VABRIDGE outcome 
api_va_set_non_persistent_entities( ENTITY_LIST& e_list,
									va_surface_mesh_options* surf_mesh_opts,
									AcisOptions* ao = NULL );
...
DECL_VABRIDGE outcome 
api_va_set_non_subdividable_entities( ENTITY_LIST& e_list,
									va_surface_mesh_options* surf_mesh_opts,
									AcisOptions* ao = NULL );
...
DECL_VABRIDGE outcome 
api_va_set_non_defeaturable_entities( ENTITY_LIST& e_list,
									va_surface_mesh_options* surf_mesh_opts,
									AcisOptions* ao = NULL );
 ...
 */
DECL_VABRIDGE outcome 
api_va_export_mesh( const va_mesh *p_mesh,
 ...
 */
	mesh_check_options(int type, int size) :check_results(0)
	{
		check_type = type;
		if ( size > 0 )
			check_results = ACIS_NEW double[size];
	}
 ...
 */
	...
	{ 
		if ( check_results ) 
			ACIS_DELETE [] STD_CAST check_results;
	}
 ...
 */
DECL_VABRIDGE outcome 
api_va_check_mesh( const va_mesh *p_mesh,
				   mesh_check_options& mco,
                   AcisOptions *ao = NULL );
 ...
 */
DECL_VABRIDGE outcome 
api_va_set_integer_meshing_parameter( int param_num,
									  int param_value,
									  va_base_mesh_options *mesh_opts,
									  AcisOptions *ao = NULL );
 ...
 */
DECL_VABRIDGE outcome 
api_va_set_double_meshing_parameter( int param_num,
									 double param_value,
									 va_base_mesh_options *mesh_opts,
									 AcisOptions *ao = NULL );
 ...
 */
DECL_VABRIDGE
outcome api_va_get_vki_handles(const va_volmesh *p_mesh,
                               vis_Connect *& vki_connect,
                               vis_VolMesh *& vki_mesh,
                               va_base_mesh_options* mopts = NULL,
                               AcisOptions *ao = NULL);
