...
#if defined( __dm2stub ) || defined( __SpaACIS ) || defined( __SPAAcisDs )
...
#  define DECL_DM2STUB EXPORT_SYMBOL
# else
#  define DECL_DM2STUB IMPORT_SYMBOL
# endif
#else
# define DECL_DM2STUB
#endif
