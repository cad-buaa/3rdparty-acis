...
#if defined( __clear ) || defined( __SpaACIS ) || defined( __SPAAcisDs )
#define BUILDING_LOCAL_FILE
#endif

#include "importexport.h"
#include "acis/gme/clearance/gme_clearance.hxx"

#ifdef IMPORT_EXPORT_SYMBOLS
# ifdef BUILDING_LOCAL_FILE
#  define DECL_CLR EXPORT_SYMBOL
# else
#  define DECL_CLR IMPORT_SYMBOL
# endif
#else
# define DECL_CLR
#endif
