...
#if defined( __query_husk ) || defined( __SpaACIS ) || defined( __SPAAcisDs )
#define BUILDING_LOCAL_FILE
#endif

#include "importexport.h"
#include "acis/gme/query/gme_query.hxx"

#ifdef IMPORT_EXPORT_SYMBOLS
# ifdef BUILDING_LOCAL_FILE
#  define DECL_QUERY EXPORT_SYMBOL
# else
#  define DECL_QUERY IMPORT_SYMBOL
# endif
#else
# define DECL_QUERY
#endif
...
#    define spa_lib_name "query_husk"
#   else
